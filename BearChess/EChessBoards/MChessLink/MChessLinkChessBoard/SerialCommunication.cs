...
namespace www.SoLaNoSoft.com.BearChess.MChessLinkChessBoard
{
    ...
    public class SerialCommunicationOld : AbstractSerialCommunication
    {
        ...
        public SerialCommunicationOld(ILogging logger, string portName) : base(logger, portName, Constants.MChessLink)
        {
        }
