...
{
    public class EChessBoardT : AbstractEBoard
    {
        ...
        public EChessBoardT(string basePath, ILogging logger, string portName, bool useBluetooth)
        {
            _useBluetooth = useBluetooth;
            _serialCommunication = new SerialCommunicationT(logger, portName, useBluetooth);
            ...
            Information = Constants.Tabutronic;
        }

        public EChessBoardT(ILogging logger)
        {
            _logger = logger;
            BatteryLevel = "100";
            BatteryStatus = "Full";
        ...
        {
            _serialCommunication = new SerialCommunicationT(_logger, portName, _useBluetooth);
