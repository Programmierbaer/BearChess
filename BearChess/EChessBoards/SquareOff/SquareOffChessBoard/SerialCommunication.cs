...
namespace www.SoLaNoSoft.com.BearChess.SquareOffChessBoard
{
    public class SerialCommunication : AbstractSerialCommunication
    {
        ...
        public SerialCommunication(bool isFirstInstance, ILogging logger, string portName, bool useBluetooth, string boardName) : base(
            isFirstInstance, logger, portName, boardName)
        {
