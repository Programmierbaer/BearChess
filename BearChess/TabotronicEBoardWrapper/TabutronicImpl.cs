...
namespace www.SoLaNoSoft.com.BearChess.Tabutronic.Sentio.EBoardWrapper
{
    public class TabutronicImpl : AbstractEBoardWrapper
    {
        ...
        public TabutronicImpl(string name, string basePath) : base(name, basePath)
        {
        }

        public TabutronicImpl(string name, string basePath, string comPortName, bool useBluetooth) : base(
