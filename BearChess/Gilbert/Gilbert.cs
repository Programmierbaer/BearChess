...
namespace www.SoLaNoSoft.com.BearChess.Engine
{
    public class Gilbert : IChessEngine
    {
        ...
        private static readonly List<IMove> CurrentMoveList = new List<IMove>(5);
        ...
        public Gilbert()
        {
            ...
            _chessBoard.Init();
            _logger = new FileLogger($"gilbert_{DateTime.UtcNow.Ticks}.log");
            _logger.Log("========================================");
        ...
        public async Task<IMove> Evaluate()
        {
            return await Evaluate(3);
        }

        public async Task<IMove> Evaluate(int maxDeep)
        {
            _stop = false;
            _logger.Continue();
        ...
        public List<IMove> GetBestMovesLine()
        {
