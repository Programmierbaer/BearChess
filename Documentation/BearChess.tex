...
If you use the Chesstimation module by Andras Petersik, you should switch on this option.
...
\subsection*{Version 0.9.11.0 $\Rightarrow$  0.9.11.1}
\begin{itemize}	
