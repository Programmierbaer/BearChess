...
\begin{itemize}
    \item Duels and tournaments are new features. There are certainly still some errors in it.
...
\section{Next Steps}
The next releases will include many new features, such as analytics and adjusted playing strength. It will also improve the functions of "Easy playing" and "Analysis mode".
