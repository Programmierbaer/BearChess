...
\begin{itemize}
    \item \textbf{UCI configuration} Buttons are not supported.	
    \item \textbf{UCI configuration} Some textual informations are wrong interpreted.	
...
\begin{itemize}
	...
	\item Improvements on handling UCI configuration.
