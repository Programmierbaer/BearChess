...
Use the cursor keys and the scroll up and down keys to maneuver through the list.
...
\begin{itemize}
	    \item Improve MessChess chess computer emulation by Franz Huber.	 
...
\subsection{Version 0.5.6.2 =\textgreater 0.5.7.0}
\begin{itemize}
...
\subsection{Version 0.5.6.1 =\textgreater 0.5.6.2}
\begin{itemize}
	\item Fix send invalid fen position to engines.
	\item Fix running coach engine from current position.
\end{itemize}

\subsection{Version 0.5.6.0 =\textgreater 0.5.6.1}
\begin{itemize}
	\item Fix broken "Analyze mode".
	\item Fix "Arange windows". 
\end{itemize}

\subsection{Version 0.5.5.3 =\textgreater 0.5.6.0}
\begin{itemize}
