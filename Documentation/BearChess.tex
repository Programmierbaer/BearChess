...
If you have installed the latest Certabo software, select the avatar.exe file from the engines subfolder as the new engine. BearChess looks at the 'avatar\_weights' subfolder and ask you to select an avatar.
...
\end{figure}
Use only BearChess or your electronic chessboard to make any moves. You can use the emulaton window to set options, e.g. levels or time control. When you play a game against a MessChess engines, the selected time control for the game cannot transferred to the emulation. 
...
\section{Next Steps}
The next releases will extend the game analysis.
