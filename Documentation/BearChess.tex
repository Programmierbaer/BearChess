...
\begin{itemize}
	...
	\item  \includegraphics[scale=0.5]{balance_unbalance.png}  \textbf{Captured pieces} shows the captured pieces window at startup or on demand.
\end{itemize}
...
To install a new engine click on \includegraphics[scale=0.5]{file_extension_exe.png} and select an UCI engine file, e.g. the latest Stockfish exe file. Or you just drag \& drop the exe file onto the button.
\begin{figure}[H]
	\centering
