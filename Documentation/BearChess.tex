...
\item  \includegraphics[scale=0.05]{tabutronic_logo_def.png} \textbf{Tabutronic} opens a window where you can configure and connect to Tabutronic chessboards (Sentio and Cerno).  Read more on chapter \textbf{\ref{ConfigureCertabo}  \nameref{ConfigureCertabo}} on page \pageref{ConfigureCertabo}.	
...
Currently, I did not have a board available.
If you already have one, try to include it as a Certabo board. 
