...
\begin{document}
	...
	\begin{abstract}
	    ...
	    \textbf{The next version will have a special mode and an adapted GUI for visually impaired players.
		The Tactum chessboard from TabuTronics, the first electronic chessboard for visually impaired players, will be integrated.\\}
		...
		\textbf{House of Staunton} from Zmartfun, \textbf{ChessUp}, \textbf{NOVAG Citrine and UCB}, and \textbf{Saitek} boards with an \textbf{OSA} interface (Galileo, Leornado, Renaissance).\\
	...
	\begin{enumerate}
		...
		\item Play with \textbf{TabuTronic Cerno, Sentio} chessboards.	  
		...
		\item Play with \textbf{Chessnut Air/Air+, Pro, Go, Evo} chessboard.	  	  	  
	...
	\end{figure}
	\begin{itemize}
		\item  \includegraphics[scale=0.6]{BearChessIcon.png} \textbf{BearChess} opens a window where you can change some BearChess basic settings.  Read more on chapter \textbf{\ref{ConfigureBearChess}  \nameref{ConfigureBearChess}} on page \pageref{ConfigureBearChess}.
...
\subsection*{Version 1.0.10.0 $\Rightarrow$  1.0.10.1}
\begin{itemize}			
	\item {\color{red}Fix}: Reading Polyglot opening book
	\item {\color{red}Fix}: Reading PGN
	\item {\color{red}Fix}: Wrong version number (1.10.0.0 instead 1.0.10.0)
