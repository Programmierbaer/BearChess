...
\begin{document}
	...
	\begin{abstract}
		...
		Many thanks to Graham O'Neill for the Chessnut Evo driver. For more details
		look at his website on \url{https://goneill.co.nz/chess}.\\
...
\end{figure}
The driver developed by Graham O'Neill must be installed on the Chessnut Evo. For more details
look at his website on (\url{https://goneill.co.nz/chess}).\\
