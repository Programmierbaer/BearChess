...
\begin{itemize}
	...
	\item Configure the electronic chessboard connection.
...
\begin{itemize}
	...
	\item \textbf{Easy playing} This is the mode in the beginning. You just can simply start making your moves on the screen on your electronic chessboard. In addition to support you can start chess programs or load opening books. But these only give hints, but do not play as opponents. This mode is automatically set if you are not playing in another mode.
	\begin{figure}[H]
		\centering
...
Above you have access to different functions of BearChess.
...
\end{figure}
\begin{itemize}
	\item \includegraphics[scale=0.2]{bearchess.png} \textbf{Start a new game} opens a new window to select opponents and time control.
	\item \includegraphics[scale=0.5]{robot.png} \textbf{Run in analyze mode} allows you to analyze games or positions with suppport of several chess engines.
	\item \includegraphics[scale=0.03]{Chess_Board.png} \textbf{Setup position}
...
\begin{itemize}
	...
	\item \includegraphics[scale=0.2]{bearchess_2.png}  \textbf{Show \& Load} opens a new window in which you can see and load all your previously saved games.
\end{itemize}
All games are saved in a PGN file.
...
\end{figure}
\begin{itemize}
	\item \includegraphics[scale=0.5]{book_open.png} \textbf{Load \& manage opening books} opens a new window in which you can install or load  your opening books.
\end{itemize}
BearChess can handle Polyglot and Arena opening books.
...
\end{figure}
\begin{itemize}
	\item  \includegraphics[scale=0.9]{Board2DPieces32.png} \textbf{Board \& Pieces} opens a window where you can change the appearance of the chessboard and the pieces. 
	\item \includegraphics[scale=0.5]{arrow_rotate_anticlockwise.png}  \textbf{Rotate board} if you like to play with black. 
...
\end{figure}
\begin{itemize}
	\item  \includegraphics[scale=0.1]{Certabo_icon.png} \textbf{Certabo} opens a window where you can configure and connect to Certabo chessboards.
	\item  \includegraphics[scale=0.05]{Millennium ChessLink.png} \textbf{Millennium ChessLink} opens a window in which you can configure chessboards connected to Millennium ChessLink and connect to them.
...
\section{Install, Configure and Load a chess engine}
...
\subsection{Install a new engine}

To install a new engine click on \includegraphics[scale=0.5]{file_extension_exe.png} and select an UCI engine file, e.g. the latest Stockfish exe file. If the file detected as UCI engine, confirm your selection.\\
...
\subsubsection{Use opening book {\color{red}*}}
Some engines comes with there own opening book and you have an option to use them or not. You can also tell BearChess to use an opening book before the moves are calculated by the engines.
...
\section{Load and Manage Opening Books}

\begin{figure}[H]
	\centering
	\includegraphics[scale=1.0]{LoadManageBooks1.png}
...
\section{Configure Board and Pieces}
...
\begin{figure}[H]
	\centering
	\includegraphics[scale=0.9]{Pieces.png}
	\caption{Example for new pieces }
	\label{fig:Pieces}
\end{figure}

If BearChess find all files inside the directory it builds an piece set to confirm your choice. A name for your set is required.
...
\section{Electronic chessboards}
...
\subsection{Configure Certabo boards}
\begin{figure}[H]
	\centering
...
\subsection{Configure Millennium ChessLink}
\begin{figure}[H]
	\centering
...
{\color{red}*} You cannot use an electronic chessboard for a pure engine match. This is still in development.\\
...
{\color{red}*} "Thinking on opponent's time" is also known as ponder. Use the configuration dialog to activate or deactivate it. The checkbox control is still in development.\\
...
\textbf{{\color{red}*} "Start the clock after the move is executed on the electronic board"} avoids a time gap to execute the moves of the engines on the board.
...
BearChess stores all games in one PGN file. When you save a game for the first time, you must first select a PGN file.\\
...
\begin{itemize}
	\item \includegraphics[scale=0.5]{folder_add.png} Create a new games file.
	\item \includegraphics[scale=0.5]{file_manager.png} Open an existing games file.
	\item \includegraphics[scale=0.5]{bin.png} Delete selected game.
	\item \includegraphics[scale=0.5]{door_out.png} Close the window.
\end{itemize}

{\color{red}*} Currently BearChess does not support a search a filter function.
...
\begin{itemize}
	...
	\item Improvements on handling opening books.
	\item Improvements on handling saved games.
\end{itemize}

\pagebreak

\section{Changelog}
\subsection{Version 0.3.1 =\textgreater 0.3.1.1}
\begin{itemize}
	\item \textbf{Hotfix} Error at pure engine match.
	\item Improvements in the handling of UCI configuration values.
\end{itemize}

\subsection{Version 0.3.0 =\textgreater 0.3.1}
\begin{itemize}
