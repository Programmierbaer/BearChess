...
\begin{itemize}
	...
	\item \textbf{Load last engine on start} if you always want to play immediately with an engine in 'Easy playing' mode.	
...
\end{itemize}
The small \includegraphics[scale=0.3]{folder.png} button opens a file or directory selection dialog, depending on the configuration name (file, path, dir).\\
...
\section{Changelog}
\subsection{Version 0.3.3.0 =\textgreater 0.3.4.0}
\begin{itemize}
