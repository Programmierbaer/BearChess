...
\end{itemize}
All games are saved in a PGN file. Read more on chapter \textbf{\ref{games}  \nameref{games}} on page \pageref{games}.
...
\begin{itemize}
	\item \textbf{Yes} opens the new game dialog (see \textbf{\ref{SelectOpponent}  \nameref{SelectOpponent}} on page \pageref{SelectOpponent})
	\item \textbf{No} resets to base position.
	\item \textbf{Cancel} continues.
\end{itemize}
