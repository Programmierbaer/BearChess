...
This is available only if you are connected to an electronic chessboard and a game has been loaded from the game manager. In this case BearChess will ask you if you want to analyze a game.\\
\begin{figure}[H]
	\centering
