...
{\color{red}\textbf{*}} Currently, a BearChess engine is only used in conjunction with an iChessOne chessboard (see \textbf{\ref{ConfigureIChessOne}  \nameref{ConfigureIChessOne}} on page \pageref{ConfigureIChessOne} and \textbf{\ref{BuddyBearChessEngines}  \nameref{BuddyBearChessEngines}} on page \pageref{BuddyBearChessEngines}).
...
{\color{red}\textbf{*}} This is not supported on DGT e-Board, Square Off Pro, ChessUp, NOVAG and Saitek OSA boards.
...
The task of a "BearChess" engine (default for Spike if no other engine is defined for that task) is to quickly give an evaluation for all possible moves when a piece is raised.
