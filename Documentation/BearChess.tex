...
BearChess supports \textbf{Certabo} chessboards, chessboards connected via \textbf{Millennium} ChessLink or Millennium eOne, the \textbf{DGT} e-Boards or Pegasus chessboard and \textbf{Square Off Pro}.\\
...
\begin{enumerate}
	  ...
	  \item Play with Millennium chessboards via ChessLink modul.
 	  \item Play with DGT e-Board or Revelation.	  
...
For your DGT e-Board you may need to configure if you want to use a COM port or Bluetooth. 
...
\begin{itemize}
	\item The support of DGT Revelation is not fully tested.
...
\subsection{Version 0.6.2.1 $\Rightarrow$  0.6.7.0}
\begin{itemize}
