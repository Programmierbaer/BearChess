...
The final version of iChessOne will have a built-in battery. BearChess will be able to display the battery level in the next version.
...
\begin{itemize}		
	\item {\color{red}Fix}: Fix DGT e-Boards
\end{itemize}
