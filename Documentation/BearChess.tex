...
\end{figure}
\begin{itemize}
	\item \includegraphics[scale=0.2]{bearchess.png} \textbf{Play a new game} opens a new window to select opponents and time control.
...
\begin{itemize}
	...
	\item \includegraphics[scale=0.5]{file_manager.png}  \textbf{Show \& Load} opens a new window in which you can see and load all your previously saved games.
\end{itemize}
...
\subsection{Easy start or restart of a game} 

The button \includegraphics[scale=0.2]{bearchess_2.png} 

If your not active playing a game
...
{\color{red}*} Currently BearChess does not support a search or filter function.
