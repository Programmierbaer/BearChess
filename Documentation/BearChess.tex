...
Unlike the other chessboards, the DGT Pegasus requires a Bluetooth LE (Bluetooth Low Energy, formerly marketed as Bluetooth Smart) connection. Make sure that your Bluetooth adapter also supports LE.
...
\begin{itemize}
	...
	\item You cannot to play an engine match with the same engine. This will fixed in the next version.
